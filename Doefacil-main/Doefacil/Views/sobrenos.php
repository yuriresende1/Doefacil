...
Junte-se a nós nessa jornada de generosidade e compaixão. Cada doação conta e, juntos, podemos fazer a diferença."</p>
        ...
        <div class="container">
          <div class="item">
            <h2>CEO</h2>
            <a href="https://www.linkedin.com/in/yuri-resende/" target="_blank">
            <img src="../assets/images/avatar/CEO.png">
            </a>
            <div class="descimg">Yuri Resende</div>
          </div>
          <div class="item">
            <h2>Desenvolvedor</h2>
            <a href="https://www.linkedin.com/in/gabriel-de-paula-caetano-531861240/" target="_blank">
            <img src="../assets/images/avatar/FULLSTACK.png">
            </a>
            <div class="descimg">Gabriel Caetano</div>
          </div>
          <div class="item">
            <h2>Desenvolvedor</h2>
            <a href="https://arcanjo321.github.io/mini-portfolio/" target="_blank">
            <img src="../assets/images/avatar/FRONTEND.png">
            </a>
            <div class="descimg">Lucas Arcanjo</div>
          </div>
          <div class="item">
            <h2>Gerente de dados</h2>
            <img src="../assets/images/avatar/GERENTEBD.png">
            <div class="descimg">Marcos Aurélio</div>
          </div>
        </div>
    <footer>
      <h3>Atendimento</h3>
